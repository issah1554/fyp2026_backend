...
This document lists the available method-level HTTP endpoints exposed by the Django application router. Each row maps to one endpoint method and includes the database permission code used for UI access management. Public endpoints do not require a bearer token and do not use DB permission codes.
...
| Method | Path | Permission Code | Auth | Status | Notes |
| --- | --- | --- | --- | --- | --- |
| GET | `/api/v1/commodities/categories` | Public | None | Working | List commodity categories. |
| POST | `/api/v1/commodities/categories` | `commodities.categories.create` | Bearer token | Working | Create commodity category. |
| GET | `/api/v1/commodities/categories/{category_id}` | Public | None | Working | Get commodity category by public ID. |
...
| Method | Path | Permission Code | Auth | Status | Notes |
| --- | --- | --- | --- | --- | --- |
| GET | `/api/v1/commodities/units` | Public | None | Working | List commodity measurement units. |
| POST | `/api/v1/commodities/units` | `commodities.units.create` | Bearer token | Working | Create commodity unit. |
| GET | `/api/v1/commodities/units/{unit_id}` | Public | None | Working | Get commodity unit by public ID. |
...
| Method | Path | Permission Code | Auth | Status | Notes |
| --- | --- | --- | --- | --- | --- |
| GET | `/api/v1/commodities` | Public | None | Working | List commodities. |
| POST | `/api/v1/commodities` | `commodities.create` | Bearer token | Working | Create commodity. |
| GET | `/api/v1/commodities/{commodity_id}` | Public | None | Working | Get commodity by public ID. |
...
| Method | Path | Permission Code | Auth | Status | Notes |
| --- | --- | --- | --- | --- | --- |
| GET | `/api/v1/markets` | Public | None | Working | List markets. |
| POST | `/api/v1/markets` | `markets.create` | Bearer token | Working | Create market. |
| GET | `/api/v1/markets/{market_id}` | Public | None | Working | Get market by public ID. |
...
| Method | Path | Permission Code | Auth | Status | Notes |
| --- | --- | --- | --- | --- | --- |
| GET | `/api/v1/market-prices` | Public | None | Working | List market commodity prices. |
| POST | `/api/v1/market-prices` | `market_prices.create` | Bearer token | Working | Create market commodity price. |
| GET | `/api/v1/market-prices/{price_id}` | Public | None | Working | Get market commodity price by public ID. |
...
| GET | `/api/v1/markets/{market_id}/prices` | Public | None | Working | List prices for a market. |
| POST | `/api/v1/markets/{market_id}/prices` | `market_prices.create` | Bearer token | Working | Create price for a market. |
| GET | `/api/v1/markets/{market_id}/latest-prices` | Public | None | Working | Latest price per commodity in a market. |

## Commodity Price Views

| Method | Path | Permission Code | Auth | Status | Notes |
| --- | --- | --- | --- | --- | --- |
| GET | `/api/v1/commodities/{commodity_id}/prices` | Public | None | Working | List prices for a commodity across markets. |
| GET | `/api/v1/commodities/{commodity_id}/price-history` | Public | None | Working | View commodity price history. |
| GET | `/api/v1/commodities/{commodity_id}/price-comparison` | Public | None | Working | Compare commodity prices across markets. |

## Administrative Areas

| Method | Path | Permission Code | Auth | Status | Notes |
| --- | --- | --- | --- | --- | --- |
| GET | `/api/v1/areas` | Public | None | Working | List administrative areas. |
...
| GET | `/api/v1/areas/{area_id}` | Public | None | Working | Get administrative area by public ID. |
...
| Method | Path | Permission Code | Auth | Status | Notes |
| --- | --- | --- | --- | --- | --- |
| GET | `/api/v1/listings` | Public | None | Working | List commodity listings. |
| POST | `/api/v1/listings` | `listings.create` | Bearer token | Working | Create commodity listing. |
| GET | `/api/v1/listings/{listing_id}` | Public | None | Working | Get commodity listing by public ID. |
